...
/**
 * Examples of the Spring shell commands.
 *
 * These are all copied from the Spring Shell examples.
 * See: https://github.com/spring-projects/spring-shell/blob/master/spring-shell-samples/src/main/java/org/springframework/shell/samples/standard/Commands.java
 */
